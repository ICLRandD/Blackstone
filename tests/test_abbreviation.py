...
from blackstone.abbreviations import AbbreviationDetector, find_abbreviation, filter_matches
...
class TestAbbreviationDetector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.text = "The European Court of Human Rights (ECtHR) is responsible for applying the European \
    ...
    def test_filter_matches(self):
        ...
        assert long.string == "The European Court of Human Rights"
        assert short.string == "ECtHR"
