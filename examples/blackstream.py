...
HEADERS = {"User-Agent": "Chrome", "From": "daniel.hoadley@iclr.co.uk"}
...
# year selector
year = st.sidebar.selectbox("Select a year", range(2000, 2020))
...
if st.sidebar.button("Search"):
    if case_number:
        ...
        if court == "Court of Appeal (Civil Division)":
            target = (
                EW_BASE_URL + "EWCA/Civ/" + str(year) + "/" + str(case_number) + ".html"
            )
